...
{
	this -> clear_fields();
	this -> event_tree = (TTree*)(this -> file_chain -> Get( "eventTree" ));
...
{
	this -> clear_fields();
	this -> lumi_tree = (TTree*)(this -> file_chain -> Get( "lumiTree" ));
...
{
	this -> clear_fields();
	this -> run_tree = (TTree*)(this -> file_chain -> Get( "runTree" ));
...
{
	this -> clear_fields();
	this -> traj_tree = (TTree*)(this -> file_chain -> Get( "trajTree" ));
...
{
	this -> clear_fields();
	this -> clust_tree = (TTree*)(this -> file_chain -> Get( "clustTree" ));
