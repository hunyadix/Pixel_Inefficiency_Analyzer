...
#NTUPLE_READER_SETUP_S = ./Resources/Sources/Includes/Ntuple_reader/ntuple_reader_setup.$(SrcSuf)
#NTUPLE_READER_SETUP_O = ./Resources/Objects/ntuple_reader_setup.$(ObjSuf)
#OBJS          += $(NTUPLE_READER_SETUP_O)
CUSTOM_SMART_HISTOS_S = ./Resources/Sources/Includes/SmartHistos/Custom_smart_histos.$(SrcSuf)
CUSTOM_SMART_HISTOS_O = ./Resources/Objects/Custom_smart_histos.$(ObjSuf)
OBJS          += $(CUSTOM_SMART_HISTOS_O)
...
#$(NTUPLE_READER_SETUP_O): $(NTUPLE_READER_SETUP_S)
#	@printf "Compiling ntuple reader setup...\n"
#	@$(CXX) $(CXXFLAGS) $(LIBS) -c $< $(OutPutOpt)$@
#	@printf "Ntuple reader setup compiled.\n"
$(CUSTOM_SMART_HISTOS_O): $(CUSTOM_SMART_HISTOS_S)
	@printf "Compiling custom smart histos...\n"
	@$(CXX) $(CXXFLAGS) $(LIBS) -c $< $(OutPutOpt)$@
	@printf "Custom smart histos compiled.\n"
