...
process.DynamicInefficiencyReader = cms.EDAnalyzer("SiPixelDynamicInefficiencyReader",
    ...
    thePixelChipEfficiency_FPix1 = cms.double(1),
    thePixelChipEfficiency_FPix2 = cms.double(1),
    ...
    thePUEfficiency_BPix1 = cms.vdouble( 1, 0, 0, 0 ),
    thePUEfficiency_BPix2 = cms.vdouble( 1, 0, 0, 0 ),
    thePUEfficiency_BPix3 = cms.vdouble( 1, 0, 0, 0 ),
